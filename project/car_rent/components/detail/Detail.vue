<template>
  <div class="detail_wrap con">
    <div class="area_wrap">
      ...
      <check-area :chkShow="true" ></check-area>
      <!-- // check-area components -->
      ...
      <div class="dti_section">
        <div class="pre_car_info">
          ...
          <div class="car_item_dti">
            <div class="img_txt">
              ...
              <span class="star" :class="pReviewCount(CarInfo.reviewCount)"></span>
            ...
            <ul class="pre_list">
              <li v-for="item in ReviewList" :key="item.id" >
                <div class="self_wrp">
                  ...
                  <div class="pre_scope">
                    <p>{{item.date}}</p>
                    <p class="star" :class="pReviewCount(item.reviewCount)">
                    </p>
                  </div>
                </div>
        ...
        <div class="car_list_wrap">
          <div class="car_list_swipe">
            ...
            <!-- carList components -->
            <car-list :car_list_item="CarListSwipe" :is_swiper="cpIsMobile"></car-list>
            <!-- // carList components -->
