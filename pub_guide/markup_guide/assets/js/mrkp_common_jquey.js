...
$(document).ready(function () {
  ...
  $('#urls a').each(function () {
    ...
    $('#urls a.haslink').each(function (idx) {
      ...
      $(this).click(function (e) {
        ...
        $('#btnReload').children().addClass('fa-spin');
        $(this).addClass('on');
        $('#pageShow').attr('src', link).one('load', function () {
  ...
  $('#pageShow').attr('src', $('#urls a.haslink:first').attr('href')).one('load', function () {
    $('#btnReload').children().removeClass('fa-spin');
  });
  ...
  $('#btnReload').click(function () {
    ...
    $('#pageShow').attr('src', '.' + $('#pageUrl').val()).one('load', function () {
      $('#btnReload').children().removeClass('fa-spin');
    });
  });
